...
function Payment() {
  ...
  const storePayment = () => {
    ...
    localStorage.setItem(`${username} purchaseHistory`, JSON.stringify(currentPurchaseHistory))
    clearStorage()
    ...
    <div className="body">
      ...
      <div className='payment-body'>
        <form className='information-body' onSubmit={(e) => {
          ...
          <input value={fullname} onChange={(e) => { setFullName(e.target.value) }} placeholder='Họ và tên' required></input>
          <input value={email} onChange={(e) => { setEmail(e.target.value) }} placeholder='Email' required></input>
          <input value={phoneNum} onChange={(e) => { setPhoneNum(e.target.value) }} placeholder='Số điện thoại' type='number' required></input>
          <input value={address} onChange={(e) => { setAddress(e.target.value) }} placeholder='Địa chỉ' required></input>
